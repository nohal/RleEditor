...
{
    public partial class CloneVectorForm : DialogForm
    {
        private ListViewItem _lvItem;

        public Symbol Symbol { get; set; } 

        public CloneVectorForm()
        {
            InitializeComponent();
        }

        private void CloneVectorForm_Load(object sender, EventArgs e)
        {
        ...
        private void CloneVectorForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (this.DialogResult == System.Windows.Forms.DialogResult.OK)
            {
                if (((RleEditorForm)Owner).parser.SymbolVectors.Keys.Contains(tbSymbolName.Text) || ((RleEditorForm)Owner).parser.PatternVectors.Keys.Contains(tbSymbolName.Text) || ((RleEditorForm)Owner).parser.LineVectors.Keys.Contains(tbSymbolName.Text))
                {
