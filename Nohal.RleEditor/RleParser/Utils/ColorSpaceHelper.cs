...
namespace Nohal.RleEditor.RleParser.Utils
{
    ...
    public sealed class ColorSpaceHelper
    {
        ...
        /// </summary>
        public static CIEXYZ YxytoXYZ(double Y, double x, double y)
        {
            return new CIEXYZ(Y * x / y / 100, Y / 100, Y * (1 - x - y) / y / 100);
        }
        ...
        /// Converts CIEXYZ to CIEYxy structure.
        /// </summary>
        public static CIEYxy XYZtoYxy(double x, double y, double z)
        {
            return new CIEYxy(y*100, x/(x + y + z), y/(x + y + z));
        }
